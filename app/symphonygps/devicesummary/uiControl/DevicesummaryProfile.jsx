...
export default function DevicesummaryProfile({ dataIn = {}, dataOut = {} }) {
  ...
  const {
    ...
    customProfileData={},
    hostParent="DevicesummaryMainProfilePage",
    parentProfileItemId = "DevicesummaryProfileTray"
  ...
  const device_listNode = stateItem.devicesummaryNode
  
  // -- basic states --//
  const paramDevicesummaryUptoken  = stateItem.devicesummaryUptoken
  const devicesummaryActionStatus = stateItem.devicesummaryActionStatus
  ...
  const handleInputChange = mosyFormInputHandler(stateItemSetters.setDevicesummaryNode);
  
  //use route navigation system
  const router = useRouter();
  
  //manage post form
  function postDevicesummaryFormData(e) {
    
    MosyNotify({message: "Sending request",icon:"send"})
    
    inteprateDevicesummaryFormAction(e, stateItemSetters).then(response=>{
      
      setChildDataOut({
        
        actionName : response.actionName,
        dataToken : response.newToken,
        actionsSource : "postDevicesummaryFormData",
        setters :{
      ...
      stateItemSetters.setActiveScrollId("DevicesummaryProfileTray")
  ...
  useEffect(() => {
    ...
    devicesummaryProfileData(customQueryStr, stateItemSetters, router, customProfileData)
  ...
  return (
    ...
    <div className="p-0 col-md-12 text-center row justify-content-center m-0  " id="DevicesummaryProfileTray">
      {/* ================== Start Feature Section========================== ------*/}
      
      
      <div className="col-md-12 rounded text-left p-2 mb-0  bg-white ">
        <div className={` profile_container col-md-12 m-0 p-0  ${showNavigationIsle &&("pr-lg-4 pl-lg-4 m-0")}`}>
          <form onSubmit={postDevicesummaryFormData} encType="multipart/form-data" id="device_list_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              ...
              <>{!showNavigationIsle && (<div className="col m-0 p-0 text-right ">
                {paramDevicesummaryUptoken && (
                  <DeleteButton
                  src="DevicesummaryMainProfilePage"
                  tableName="device_list"
                  uptoken={paramDevicesummaryUptoken}
            ...
            <><div className="row justify-content-end m-0 p-0 col-md-12  p-3 bg-white hive_profile_navigation " id="">
              ...
              {paramDevicesummaryUptoken && showNavigationIsle && (
                <>
        ...
        <div className="row justify-content-center m-0 p-0 col-md-12" id="">
          ...
          <div className="col-md-12 row justify-content-center m-0  p-0">
              ...
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  {device_listNode?.primkey && (
                    ...
                    label="Geofence distance (metres) "
                    ...
                    {device_listNode?.primkey && (
                      <div className="form-group col-md-4 ">
                        <label >Installation latitude</label>
                        <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_installation_latitude" name="div_installation_latitude" placeholder="Installation latitude">{device_listNode?.installation_latitude || ""}</div>
                      </div>)}
                      
                      {device_listNode?.primkey && (
                        <div className="form-group col-md-4 ">
                          <label >Installation longitude</label>
                          <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_installation_longitude" name="div_installation_longitude" placeholder="Installation longitude">{device_listNode?.installation_longitude || ""}</div>
                        </div>)}
                  ...
                  <section className="hive_control">
                    <input type="hidden" id="device_list_uptoken" name="device_list_uptoken" value={paramDevicesummaryUptoken}/>
                    <input type="hidden" id="device_list_mosy_action" name="device_list_mosy_action" value={devicesummaryActionStatus}/>
                  </section>
            ...
            {device_listNode?.primkey && (
              <section className="col-md-12 m-0 bg-white pt-5 p-0 ">
                <h5 className="col-md-12 text-left  border-bottom pl-lg-1 text-muted mb-3"> {`GPS Logs History`} </h5>
