...
//data
import { loadDevicealarmsListData, popDeleteDialog, InteprateDevicealarmsEvent  } from '../dataControl/DevicealarmsRequestHandler';
...
export default function DevicealarmsList({ dataIn = {}, dataOut = {} }) {
  
  //incoming data in from parent
  const {
    customQueryStr = "",
    customProfilePath="../devicealarms/profile",
  ...
  useEffect(() => {
    ...
    loadDevicealarmsListData(customQueryStr, stateItemSetters);
  ...
  return (
    ...
    <div className={`col-md-12 bg-white p-0 m-0  ${showDataControlSections && ("main_list_container")}  `} style={{marginTop: "0px", paddingBottom: "0px"}}>
      <form method="post" onSubmit={()=>{mosyFilterUrl({tableName:"gps_logs", keyword:stateItem.devicealarmsQuerySearchStr})}} encType="multipart/form-data">
      
      {showDataControlSections && (<div className="row justify-content-end col-md-12 text-right pt-3 pb-3 data_list_section ml-0 mr-0 mb-3 border-bottom pr-0 pl-0" id="">
        <div className="col-md-6 p-0 text-left pt-3 hive_list_title">
          <h6 className="text-muted"><b> Device Alarms </b></h6>
        </div>
        <div className="col-md-6 p-0 text-right hive_list_search_tray">
          <input type="text" id="txt_gps_logs" name="txt_gps_logs" className="custom-search-input form-control" placeholder="Search in Device Alarms "
          onChange={(e) => stateItemSetters.setDevicealarmsQuerySearchStr(e.target.value)}
          />
      ...
      <div className="table-responsive  data-tables bg-white bottom_tbl_handler">
        ...
        <div className="text-left m-0 p-0 col-md-12">
          ...
          onClick={() => {mosyPrintToPdf({elemId : "gps_logs_print_card", defaultTitle:"Device Alarms"})}}
          >
          <i className="fa fa-print "></i> Print List
        </div>
        <div className="cpointer p-2 ml-2 badge rounded border border_set badge-whte mb-3 tbl_print_to_excel_btn"
        
        onClick={() => exportTableToExcel("gps_logs_data_table", "Device Alarms.xlsx")}
        >
    ...
    <div className="col-md-12 m-0 p-0" id="gps_logs_print_card">
      <table className="table table-hover  text-left printTarget" id="gps_logs_data_table">
        <thead className="text-uppercase">
          <tr>
            ...
            <th scope="col"><b>Alarm date</b></th>
        ...
        <tbody>
          {stateItem.devicealarmsLoading ? (
            <tr>
              <th scope="col">#</th>
              <td colSpan="12" className="text-muted">
                <h5 className="col-md-12 text-center p-3 mb-5 text-muted"><i className="fa fa-spinner fa-spin"></i> Loading Device Alarms ...</h5>
              </td>
            </tr>
          ) : stateItem.devicealarmsListData?.length > 0 ? (
            stateItem.devicealarmsListData.map((listgps_logs_result, index) => {
              ...
              return(
                <Fragment key={`_row_${listgps_logs_result.primkey}`}>
                  <tr key={listgps_logs_result.primkey}>
                    ...
                    <td scope="col"><span title={listgps_logs_result.created_at}>{magicTrimText(listgps_logs_result.created_at, 70)}</span></td>
      ...
      <MosyPaginationUi
      src="DevicealarmsList"
      tblName="gps_logs"
      totalPages={stateItem.devicealarmsListPageCount}
