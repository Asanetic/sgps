...
import RegisteredsitesList from '../uiControl/RegisteredsitesList';
...
export default function RegisteredsitesMainListPage() {
              ...
              <div className="content container-fluid p-0 m-0 ">
               <Suspense fallback={<div className="col-md-12 p-5 text-center h3">Loading...</div>}>
                    ...
                    <RegisteredsitesList  
                     ...
                     dataIn={{ parentUseEffectKey: "loadRegisteredsitesList" }}
