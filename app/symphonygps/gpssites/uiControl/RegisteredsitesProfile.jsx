...
//import InteprateDevicesummaryEvent Event manager
import {InteprateDevicesummaryEvent} from '../../devicesummary/dataControl/DevicesummaryRequestHandler';

//import DevicesummaryList component
import DevicesummaryList from '../../devicesummary/uiControl/DevicesummaryList';

//button function imports
import { loadSitePage } from "../../AppCore/coreUtils";
            ...
            <><div className="row justify-content-end m-0 p-0 col-md-12  p-3 bg-white hive_profile_navigation " id="">
              ...
              <div className="col-md-8 p-0 text-right hive_profile_nav_add_new_tray" id="">
                ...
                {paramRegisteredsitesUptoken && (
                  ...
                  label=" View on map"
                  icon="map"
                  onClick={()=>{loadSitePage({record_id:sitesNode?.record_id})}}
                  />
          ...
          <div className="col-md-12 row justify-content-center m-0  p-0">
            ...
            <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
              ...
              <div className="col-md-12 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
                <h5 className="col-md-12 row p-2 justify-content-center p-0 m-0">
                  <div className="col-md-3 bg-dark mb-3 mb-lg-0 mt-lg-3" style={{height: "1px"}}></div>
                  <div className="col-md-5 text-center">Manager And Contact Person</div>
                  <div className="col-md-4 bg-dark mt-3" style={{height: "1px"}}></div>
                </h5>
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  value={sitesNode?.manager_mobile || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  value={sitesNode?.contact_person_mobile || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                  ...
                  value={sitesNode?.contact_person_email || ""}
                  onChange={handleInputChange}
                  context={{ hostParent: hostParent  }}
                  inputOverrides={{}}
                  type="text"
                ...
                <div className="row justify-content-start col-md-12 p-0 m-0 ">
                  ...
                  {sitesNode?.primkey && (
                    <div className="form-group col-md-4 hive_data_cell  ">
                      ...
                      <div className="border border_set p-2 rounded_medium form-control pt-3" id="div_total_devices" name="div_total_devices" placeholder="Total Devices">{sitesNode?.total_devices || ""}</div>
                    </div>)}
