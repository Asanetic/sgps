...
import { DeleteSystemusersmanagement } from '../systemusersmanagement/SystemusersmanagementDbGateway';
...
export async function GET(request) {
  ...
  if (deleteToken) {
    ...
    const res = await DeleteSystemusersmanagement(deleteTokenDecode, whereStr);
