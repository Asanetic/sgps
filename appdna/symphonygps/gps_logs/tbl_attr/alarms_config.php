...
$__page_title = "Device Alarms";

$core_module_configs_ = [

  //important
  "primary_table" => $primary_table__,
  "table_alias" => "devicealarms",
  "primary_key" => "primkey",
  "record_id" => "record_id",
  "main_page_title" => $__page_title,
  "api_endpoint_name" => "alarmreport",
...
$novanest_module_ui_blueprint_ = [
  ...
  "page_layout" => [
    "desired_column_order" => [
      "gps_logs" => [
        "primkey", "record_id", "created_at","log_type", "remark","site_name", "device_id", "battery",
