...
//"primkey" , "record_id" , "log_type" , "site_name" , "device_id" , "battery" , "latitude" , "longitude" , "log_details" , "speed" , "remark" , "timestamp" , "created_at" , "hive_site_id" , "hive_site_name" , <br><br>
        ...
        "custom_next_js_query_line_cols" => [
            ...
            "last_x" => [
                "function" => "await mosyCountRows('gps_logs', `where device_id ='\${row?.record_id}'`)",
                "args" => [],
    ...
    "page_layout" => [
        ...
        "desired_column_order" => [
            "device_list" => ["primkey","record_id","device_name","serial_number","site_name","site_id","geofence","date_installed","manufacture_date","remark","reg_date"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "device_list" => [
                "Device Information" => ["device_name","serial_number","site_id","geofence","manufacture_date","date_installed","remark"],
            ]
        ],
